...
>
  <div className="max-w-7xl mx-auto px-4">
    ...
    <p className="mt-4 max-w-3xl mx-auto text-lg text-gray-600 leading-relaxed">
      At Hubhawks, we're passionate about stories and the authors who tell them. We are a dynamic, creative, and collaborative team dedicated to changing the world, one book at a time.
    </p>
